...
import type { LoadedPolicy } from "../src/policy/policyEngine.js";
import type { MetricsBundle } from "../src/metrics/index.js";
...
function baseMetrics(overrides: Partial<MetricsBundle> = {}): MetricsBundle {
  return {
