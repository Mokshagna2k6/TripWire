...
export type FeedbackClassification = "false_positive" | "false_negative" | "true_positive" | "true_negative";
 ...
 */
export function classifyFeedback(systemAction: ThresholdAction, humanDecision: "ALLOW" | "BLOCK"): FeedbackClassification {
...
export async function recordFeedback(auditTraceId: string, systemAction: ThresholdAction, humanDecision: "ALLOW" | "BLOCK") {
...
export function computeFeedbackStats(records: { classification: FeedbackClassification }[]): FeedbackStats {
